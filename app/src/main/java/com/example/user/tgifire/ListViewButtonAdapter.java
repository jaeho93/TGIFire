...
public class ListViewButtonAdapter extends ArrayAdapter implements View.OnClickListener{
    ...
    ListViewButtonAdapter(Context context, int resource, ArrayList<BuildingInfoItem> list, ListBtnClickListener clickListener) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final TextView textTextView = (TextView) convertView.findViewById(R.id.textFloor);

        // Data Set(listViewItemList)에서 position에 위치한 데이터 참조 획득
        final BuildingInfoItem listViewItem = (BuildingInfoItem) getItem(position);
